...
const Login = () => {
  ...
  const SendOtp = async () => {
    ...
    console.log("mvdmnbnsbv", email, password)
    // setLoadSpiner((o) => !o);
    ...
    await axios
      ...
      .then((Response) => {
        console.log("nsgdvhsddk",Response)
          ...
          reactLocalStorage.set("userId", Response?.data?.details?._id);
