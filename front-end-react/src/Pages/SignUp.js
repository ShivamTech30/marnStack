...
const SignUp = () => {
  ...
  const [BusinessActive, setBusinessActive] = useState("USER");
  ...
  const BusinessdetailsActiveFun = (value) => {
    ...
    if (value === "individual") {
      ...
      setBusinessActive("USER");
    } else {
      setIndividualActive(false);
      setBusinessActive("ADMIN");
    }
  };
