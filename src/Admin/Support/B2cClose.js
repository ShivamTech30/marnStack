...
function B2cClose() {
  ...
  const GetSettingViewB2cCloseFeedbackData = useSelector(
    (state) =>
      state.GetSettingViewB2cCloseFeedbackReducer.GetSettingViewB2cCloseFeedbackData?.data
  );
  ...
  console.log("as",GetSettingViewB2cCloseFeedbackData)
...
const NewOldFun = (e) => { 
  if (e.target.value == "OLDEST") { 
    ...
    setOldNewData(true)
    setGetSettingViewAllData(GetSettingViewB2cCloseFeedbackData?.info) 
  }
