...
function B2BClose() {
  ...
  console.log("clossss", PostTicketDetailData);

  useEffect(() => {
    dispatch(GetSettingViewB2bCloseFeedback());
  }, []);

  console.log("as", GetSettingViewB2bCloseFeedbackData);
  ...
  const NewOldFun = (e) => {
    if (e.target.value == "OLDEST") {
      ...
      setGetSettingViewAllData(GetSettingViewB2bCloseFeedbackData?.info);
    }
  };

  useEffect(() => {
    GetSettingViewB2bCloseFeedbackData &&
      setGetSettingViewAllData(GetSettingViewB2bCloseFeedbackData?.info);
  }, [GetSettingViewB2bCloseFeedbackData]);
  return (
    <>
