...
import { GetDeliveryPriceDetail, PostViewAdminOrder } from "../../Redux/action/ApiCollection";
...
const OrderSummary = () => {
  ...
  console.log(GetDeliveryPriceDetailReducerData)
  ...
  useEffect(() => { 
    ...
    dispatch(PostViewAdminOrder({
      "product_order_id": OrderDetailsIdData?.product_order_id
    }))
    
    dispatch(GetDeliveryPriceDetail())
      ...
      <div className={`dashboard-part`}>
        ...
        <div className="content-sec">
          <div className="orderdetail-part">
            ...
            {alldata  && <div className="userinfo-box">
                ...
                <ul className="addressdetail-list">
                  <li>
                    ...
                    <div className="right-part">
                      ...
                      <p className="mb-0">
                        {alldata?.data?.user_pickup_location[0]?.address}
                      </p>
                      <p className="mb-0">
                         
                        <span> {alldata?.data?.user_pickup_location[0].phone_number} </span >
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div className="right-part">
                      <h3 className="mb-0">Delevered Address</h3>
                      <p className="mb-0">
                        {alldata?.data?.user_delivered_location[0]?.address}
                      </p>
                      <p className="mb-0">
                        
                        <span>  {alldata?.data?.user_delivered_location[0]?.phone_number} </span >
                      </p>
                    </div>
                  </li>
                </ul>
