...
import { GetSettingViewB2cFeedback , DeleteSettingDismissTicket, PostGetFeedback} from "../../Redux/action/ApiCollection";
import { isTomorrow } from "date-fns";
import { PermissionData } from "../../Permission";

function B2cfeedback() {
...
console.log("pppppc", PostGetFeedbackData)
