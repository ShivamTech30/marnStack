        ...
        <div className='row'>
          <div className='col-12'>
            ...
            <ol className='my-3'>
              ...
              <li><a href="#USER">USER REPRESENTATIONS </a></li>
              <li><a href="#PROHIBITED">PROHIBITED ACTIVITIES</a></li>
              <li><a href="#GENERATED">USER GENERATED CONTRIBUTIONS</a></li>
              <li><a href="#CONTRIBUTION">CONTRIBUTION LICENSE</a></li>
              <li><a href="#SUBMISSIONS">SUBMISSIONS</a></li>
              <li><a href="#MANAGEMENT">SITE MANAGEMENT</a></li>
            ...
            <h2 id="INTELLECTUAL">2. INTELLECTUAL PROPERTY RIGHTS</h2>
            ...
            <h2 id="GENERATED">5. USER GENERATED CONTRIBUTIONS</h2>
            ...
            <h2 id="CONTRIBUTION">6. CONTRIBUTION LICENSE</h2>
            ...
            <h2 id="SUBMISSIONS">7. SUBMISSIONS</h2>
            ...
            <h2 id="DISPUTE">12. DISPUTE RESOLUTION</h2>
            ...
            <h2 id="LIMITATIONS">15. LIMITATIONS OF LIABILITY</h2>
            ...
            <p>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our respective officers, agents, partners, and employees, from and against any loss, damage, liability, claim, or demand, including reasonable attorneys’ fees and expenses, made by any third party due to or arising out of: (1) use of the Site; (2) breach of these Terms of Use; (3) any breach of your representations and warranties set forth in these Terms of Use; (4) your violation of the rights of a third party, including but not limited to intellectual property rights; or (5) any overt harmful act toward any other user of the Site with whom you connected via the Site. Notwithstanding the foregoing, we reserve the right, at your expense, to assume the exclusive defense and control of any matter for which you are required to indemnify us, and you agree to cooperate, at your expense, with our defense of such claims. We will use reasonable efforts to notify you of any such claim, action, or proceeding which is subject to this indemnification upon becoming aware 
              of it.</p>

            <h2 id="DATA">17. USER DATA</h2>
            <p>We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

            <h2 id="ELECTRONIC">18. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
            ...
            <p>In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at: <a href="mailto:support@nitroxpress.in"> support@nitroxpress.in</a></p>
