...
function Privacycontent() {
    return (
        ...
        <section className='privacycontent mt-5 pt-5'>
            <div className='container'>
                <div className='row'>
                    <div className='col-12'>
                        <h5>Last updated October 03, 2022</h5>
                        <p> This privacy notice for NitroXpress Private Limited ('Company', 'we', 'us', or 'our',), describes how and why we might collect, store, use, and/or share ('process') your information when you use our services ('Services'), such as when you:
                        </p>
                        <ul>
                            <li>Visit our website at nitroxpress.in, or any website of ours that links to this privacy notice</li>
                            <li> Engage with us in other related ways, including any sales, marketing, or events </li>
                        </ul>
                        <p> Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at contact@nitroxpress.in.</p>
                        <h5>SUMMARY OF KEY POINTS</h5>
                        <p><i><b>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for. You can also click here to go directly to our table of contents.</b></i></p>
                        <p><b>What personal information do we process?</b> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with NitroXpress Private Limited and the Services, the choices you make, and the products and features you use. Click here to learn more.</p>
                        ...
                        <p><b> In what situations and with which types of parties do we share personal information?</b> We may share information in specific situations and with specific categories of third parties. Click here to learn more. </p>
                        <p><b> What are your rights?</b>Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Click here to learn more.</p>
                        ...
                        <p>Want to learn more about what NitroXpress Private Limited does with any information we collect? Click here to review the notice in full.</p>

                        <h2>TABLE OF CONTENTS</h2>
                        <ol className='my-3'>
                            <li><a href="#">AGREEMENT TO TERMS</a></li>
                            <li><a href="#">INTELLECTUAL PROPERTY RIGHTS</a></li>
                            <li><a href="#">USER REPRESENTATIONS</a></li>
                            <li><a href="#">PROHIBITED ACTIVITIES   </a></li>
                            <li><a href="#">USER GENERATED CONTRIBUTIONS</a></li>
                            <li><a href="#">CONTRIBUTION LICENSE</a></li>
                            <li><a href="#">SUBMISSIONS</a></li>
                            <li><a href="#">SITE MANAGEMENT</a></li>
                            <li><a href="#">TERM AND TERMINATION</a></li>
                            <li><a href="#">MODIFICATIONS AND INTERRUPTIONS</a></li>
                            ...
                            <li><a href="#">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                        ...
                        <p><i><b>In Short</b> Personal information you disclose to us</i></p>
                        <p>We collect personal information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or
                            our products and Services, when you participate in activities on the Services, or otherwise when you contact us.</p>
                        <p><b>Personal Information Provided by You.</b> The personal information that we collect depends on the context of your interactions with us and
                            the Services, the choices you make, and the products and features you use. The personal information we collect may include the following:</p>
                        <ul>
                            <li>names</li>
                            <li>phone numbers</li>
                        ...
                        <p><b>Payment Data.</b> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by RazorPay. You may find their privacy notice link(s) here: https://razorpay.com/privacy/.</p>
                        ...
                        <ul>
                            ...
                            <li><b>To fulfil and manage your orders.</b> We may process your information to fulfil and manage your orders, payments, returns, and exchanges made through the Services.</li>
                        ...
                        <h2 id='PERSONAL'>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                        ...
                        <ul>
                            ...
                            <li><b>When we use Google Maps Platform APIs.</b>We may share your information with certain Google Maps Platform APIs (e.g. Google Maps API, Places API). To find out more about Google’s Privacy Policy, please refer to this link.</li>
                        ...
                        <h2 id="KEEP">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                        <p><i><b>In Short: </b>We keep your information for as long as necessary to fulfil the purposes outlined in this privacy notice unless otherwise required by law.</i></p>
                        ...
                        <h2 id='RIGHTS'>7. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                        ...
                        <p>If you have questions or comments about your privacy rights, you may email us at support@nitroxpress.in.</p>
                        ...
                        <h2 id="RESIDENTS">9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                        ...
                        <h2 id="CONTACT">10. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                        <p><i><b>In Short:</b>  Yes, we will update this notice as necessary to stay compliant with relevant laws.
                        </i></p>
                        <p>We may update this privacy notice from time to time. The updated version will be indicated by an updated 'Revised' date and the updated version will be effective as soon as it is accessible. If we make material changes to this privacy notice, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification. We encourage you to review this privacy notice frequently to be informed of how we are protecting your information.</p>
                        <h2 id='REVIEW'>11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                        <p>If you have questions or comments about this notice, you may email us at support@nitroxpress.in or by post to:</p>
                        <p className='mb-0'>NitroXpress Private Limited</p>
                        <p className='mb-0'> Gurugram, Haryana</p>
                        <p>India</p>
                        <h2>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                        <p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please submit a request form by clicking here.</p>
                    </div>
                </div>
            </div>
        </section>
